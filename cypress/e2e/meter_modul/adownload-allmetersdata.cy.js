describe('Meters Module - View All Data Meter Groups List and Page Count', () => {
    it('Should log in successfully and view all meter group data list', () => {
        ...
        cy.get('.overflow-visible > .flex-col').scrollIntoView({ duration: 2000 }) //View All Menus & Groups Data List        cy.get('.overflow-visible > .flex-col').scrollIntoView({ duration: 2000 }) //View All Meter Groups Data List
        ...
        cy.get('#swal2-title').should('be.visible').title('Success! Meter downloaded successfully.').title({ duration: 2000 })
        cy.wait(500)
